...
<div class="mui-content mc-login">
	<div class="avatar mui-text-center">
		<img src="<?php  if($_W['setting']['copyright']['flogo']) { ?><?php  echo tomedia($_W['setting']['copyright']['flogo']);?><?php  } else { ?>resource/images/MicroEngine.ico<?php  } ?>" class="mui-img-circle"/>
	</div>
	<?php  if($type == 'email') { ?>
