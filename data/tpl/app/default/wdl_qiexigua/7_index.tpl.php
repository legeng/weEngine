...
<html>
	<head>
		...
		<title>忍者切水果</title>
		<link type="text/css" href='../addons/wdl_qiexigua/template/mobile/assets/softgames.css' rel="stylesheet">
		<style type="text/css">
<!--
body {
...
-->
	...
	<body onLoad="startCutting();">
		<div id="fb-root"></div>
		<img id="rotation" src="../addons/wdl_qiexigua/template/mobile/images/rotate.png" />
		<div id="c2canvasdiv">
        ...
        window.gameJS = ['../addons/wdl_qiexigua/template/mobile/js/jquery-2.0.0.min.js'];
    </script>
		<script type="text/javascript" src='../addons/wdl_qiexigua/template/mobile/js/jquery-2.0.0.min.js'></script>
		<script type="text/javascript" src='../addons/wdl_qiexigua/template/mobile/assets/softgames-1.1.js'></script>
		<script type="text/javascript" src='../addons/wdl_qiexigua/template/mobile/assets/sg.hooks.js'></script>
		<script language=javascript>
			document.addEventListener("touchmove", function (e) {
					e.preventDefault();
				}, false);
		var mebtnopenurl = 'http://bbs.012wz.com';
		window.shareData = {
		        "imgUrl": "../addons/wdl_qiexigua/template/mobile/images/2000.png",
		        "timeLineLink": "http://bbs.012wz.com",
		        "tTitle": "切了个瓜-微创客游戏",
		...
		<script type="text/javascript" src='../addons/wdl_qiexigua/template/mobile/js/game.js' async="async"></script>

		<div id=share style="display: none">
			<img width=100%
				src="../addons/wdl_qiexigua/template/mobile/images/2000.png"
