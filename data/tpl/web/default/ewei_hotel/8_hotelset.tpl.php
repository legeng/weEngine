	...
	<form action="" method="post" class="form-horizontal form" enctype="multipart/form-data" onsubmit='return check()'>
		...
		<div class="panel panel-default">
				...
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						<label class="radio-inline">
							<input type="radio" value="0" name="version" class="version" <?php  if($set['version']==0 || empty($set['version'])) { ?>checked<?php  } ?>/> 独立酒店版本
						</label>
						<label class="radio-inline">
							<input type="radio" value="1" name="version" class="version" <?php  if($set['version']==1) { ?>checked<?php  } ?>/> 多个酒店版本
						</label>
			...
			<div class="form-group">
				...
				<div class="col-sm-9 col-xs-12">
					<label class="radio-inline">
						<input type="radio" value="0" name="refund" class="user" <?php  if(empty($set['refund'])) { ?>checked<?php  } ?>/> 可以
					</label>
					<label class="radio-inline">
						<input type="radio" value="1" name="refund" class="user" <?php  if($set['refund']==1) { ?>checked<?php  } ?>/> 不可以
					</label>
			...
			<div class="form-group">
				...
				<div class="col-sm-9 col-xs-12">
					<label class='radio-inline'><input type="radio" name="is_unify" class="is_unify" value="0" <?php  if($set['is_unify'] == 0) { ?> checked="true" <?php  } ?>>使用各酒店电话</label>
			...
			<div class="form-group">
				...
				<div class="col-sm-9 col-xs-12">
					<label class='radio-inline'><input type="radio" name="template" value="1"  <?php  if($set['template'] == 1) { ?> checked="true" <?php  } ?> onclick="$('#templateid').show();"> 开启</label>
					<label class='radio-inline'><input type="radio" name="template" value="0" <?php  if($set['template'] == 0) { ?> checked="true" <?php  } ?> onclick="$('#templateid').hide();">关闭</label>
				</div>
			</div>
			<div class="form-group" id="templateid" <?php  if(!$set['template']) { ?>style="display: none;"<?php  } ?>>
				<label class="col-xs-12 col-sm-3 col-md-2 control-label">模板ID</label>
				<div class="col-sm-9 col-xs-12">
					<input type="text" name="templateid" class="form-control" value="<?php  echo $set['templateid'];?>" />
            ...
            <div class="form-group">
				...
				<div class="col-sm-9 col-xs-12">
					<label class='radio-inline'><input type="radio" name="is_sms" value="0" <?php  if($set['is_sms'] == 0) { ?> checked="true" <?php  } ?> onclick="$('#sms_id').show();">开启</label>
					<label class='radio-inline'><input type="radio" name="is_sms" value="1"  <?php  if($set['is_sms'] == 1) { ?> checked="true" <?php  } ?> onclick="$('#sms_id').hide();"> 关闭</label>
				</div>
			</div>
            <div class="form-group" id="sms_id" <?php  if($set['is_sms']!='0') { ?>style="display: none;"<?php  } ?>>
				<label class="col-xs-12 col-sm-3 col-md-2 control-label">短信模板ID</label>
				<div class="col-sm-9 col-xs-12">
					<input type="text" name="sms_id" class="form-control" value="<?php  echo $set['sms_id'];?>" />
