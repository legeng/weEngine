        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        <div class="input-group">
                            <input type="text" name="template" value="<?php  echo $setting['template'];?>" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        <input type="text" name="url" value="<?php  echo $setting['url'];?>" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        <textarea class="form-control" name="caption" row="8"><?php  echo $setting['caption'];?></textarea>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        <textarea class="form-control" name="remark" row="8"><?php  echo $setting['remark'];?></textarea>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        <div class="alert alert-info">
                            支付金额：{<?php echo 订单金额;?>} <br>
                            商品信息：{<?php echo 商品名称;?>} <br>
                            这些数据将由系统自动调用
                        </div>
                    </div>
                </div>
