...
//			$feedback['address'] = $addresses[$addressid];
	...
	public function doMobileConfirm() {
		...
		$row = pdo_fetch("SELECT * FROM " . tablename('mc_member_address') . " WHERE isdefault = 1 and `uniacid` = :uniacid AND uid = :uid limit 1", array(':uid' => $_W['fans']['uid'], ':uniacid' => $_W['uniacid']));
